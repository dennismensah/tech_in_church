...
class ChurchTodayView extends StatelessWidget {
  const ChurchTodayView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ChurchTodayBloc, ChurchTodayState>(
      builder: (context, state) {
        return LiquidPullToRefresh(
          ...
          onRefresh: () async {
            context
                .read<ChurchTodayBloc>()
                .add(const ChurchTodayEvent.churchTodayRecordsFetched());
          }, // refresh callback
          child: state.map(
            ...
            loadedSuccessfully: (e) => e.churchTodayRecords.isEmpty
                ? Center(
                ...
                : ListView.builder(
                    ...
                    itemCount: e.churchTodayRecords.length,
                      ...
                      return Card(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                e.churchTodayRecords[index].title,
                                style: Theme.of(context)
                                    .textTheme
                                    .subtitle1
                                    ?.copyWith(
                              ...
                              ReadMoreText(
                                e.churchTodayRecords[index].details,
                                trimLines: 5,
                                style: Theme.of(context)
                                    .textTheme
                                    .subtitle1
                              ...
                              Text(
                                e.churchTodayRecords[index].dayname,
                                style: Theme.of(context)
                                    .textTheme
                                    .subtitle2
