  ...
  showConfirmDialog(BuildContext context, String secret,
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          content: Text(
              'You are about to make an offering of USD ${state.amount.getOrElse('')}.'),
          actions: [
            TextButton(
              onPressed: () {
                context.router.pop();
    ...
    return MultiProvider(
      providers: [
        BlocProvider(
          create: (context) => getIt<OfferingBloc>()
            ..add(OfferingEvent.amountChanged(amount.toString())),
        ),
        BlocProvider(
      ...
      child: Scaffold(
        ...
        body: Container(
          ...
          child:
              BlocListener<NonPayEventsActionsBloc, NonPayEventsActionsState>(
                ...
                state.authFailureOrSuccessOption.fold(
                  ...
                  (either) {
                    either.fold(
                      ...
                      (secret) {
                        showConfirmDialog(
                            context, secret, paymentMethod.value!, state);
                      },
                    );
                  },
                );
                ...
                return SingleChildScrollView(
                  ...
                  child: Form(
                    ...
                    autovalidateMode: AutovalidateMode
                        .onUserInteraction, //state.showErrorMessages,
                    child: Column(
                      children: [
                        Padding(
                          ...
                          child: TextInput(
                            ...
                            onChanged: (value) {
                              ...
                              context.read<OfferingBloc>().add(
                                  OfferingEvent.cardNumberChanged(value ?? ''));
                            },
                            validator: (_) => context
                                .read<OfferingBloc>()
                                .state
                              ...
                              Expanded(
                                child: TextInput(
                                  ...
                                  onChanged: (value) {
                                    ...
                                    context.read<OfferingBloc>().add(
                                        OfferingEvent.cvcChanged(value ?? ''));
                                    // cvvFocused.value = false;
                                  },
                                  validator: (_) => context
                                      .read<OfferingBloc>()
                        ...
                        Padding(
                          ...
                          child: TextInput(
                            ...
                            prefix: '\$',
                            keyboardType: TextInputType.number,
                            enabled: false, //!state.isSubmitting,
                            title: 'Amount',
                            showError: !state.cvc.isValid(),
