...
class AnnouncementRemoteDataSource implements IAnnouncementRemoteDataSource {
  ...
  Future<Response?> getAnnouncements() async {
    ...
    try {
      final response = await httpClient.get('members/annoucements');
      return response;
    } on DioError catch (e) {
      print(e);
